   ...
   public bool Line17;
    ...
    void Update()
    {
        ...
        if(Helditem != null && Helditem.name.Contains("Wool")){
            if(GetComponent<SpriteRenderer>().sprite.name.Contains("playerforward") || GetComponent<SpriteRenderer>().sprite.name.Contains("playerba")) Helditem.GetComponent<Transform>().position = transform.position;

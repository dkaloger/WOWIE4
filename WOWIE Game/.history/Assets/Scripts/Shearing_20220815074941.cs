...
public class Shearing : MonoBehaviour
{
    ...
    [SerializeField] private Sprite deadShearedSheep;
    [SerializeField] private Sprite deadFullSheep;
    ...
    void Update()
    {
        if(dead){
            if(t2 == 0){
                ...
                if(GetComponent<SpriteRenderer>().sprite == shearedsheep) gameObject.GetComponent<SpriteRenderer>().sprite = shearedsheep;
            ...
            if(t2 >= 60){
                ...
                if(deathcloud != null && GetComponent<SpriteRenderer>().enabled){

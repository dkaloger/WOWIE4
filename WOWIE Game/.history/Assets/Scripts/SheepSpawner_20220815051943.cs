...
public class SheepSpawner : MonoBehaviour
{
    ...
    private void Spawn(){
        ...
        if(zonesCount[i]<2 && i > -1){
            ...
            GameObject sh2 = Instantiate(sheep, new Vector2(sheepPos.x += Random.Range(-5,5)sheepPos.x += Random.Range(-5,5)), Quaternion.identity);
            GameObject sh3 = Instantiate(sheep, sheepPos, Quaternion.identity);
            GameObject sh3 = Instantiate(sheep, sheepPos, Quaternion.identity);

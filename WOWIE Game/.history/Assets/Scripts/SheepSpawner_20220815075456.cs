...
public class SheepSpawner : MonoBehaviour
{
    ...
    public static int[] zonesCount = new int[] { 0, 0, 0 };
    private float[][] zoneBounds = { new float[] { -12f, 15.4f, -7.8f, 41f }, new float[] { 18.4f, 60.3f, -7.8f, 6.2f }, new float[] { 60.3f, 75.5f, -7.8f, 16.9f } };
    public static int[] indivCount = new int[] { 0, 0, 0 };

   ...
   public bool Line17;
    ...
    void Update()
    {
        ...
        if (Helditem != null )
        {
            ...
            anim.SetBool("Carrying ore", Helditem.name.Contains("Wool"));
        ...
        if(Helditem != null && Helditem.name.Contains("Wool")){
            if(GetComponent<SpriteRenderer>().sprite.name.Contains("playerforward") || GetComponent<SpriteRenderer>().sprite.name.Contains("playerbackward")) Helditem.GetComponent<Transform>().position = transform.position;
            if(GetComponent<SpriteRenderer>().sprite.name.Contains("playerright")) Helditem.GetComponent<Transform>().position = new Vector2(transform.position.x+1,transform.position.y);
            if(GetComponent<SpriteRenderer>().sprite.name.Contains("playerleft")) Helditem.GetComponent<Transform>().position = new Vector2(transform.position.x-1,transform.position.y);
        }

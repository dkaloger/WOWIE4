   ...
   public bool Line17;
    ...
    void Update()
    {
        ...
        if(Helditem != null && Helditem.name.Contains("Wool")){
            ...
            if(GetComponent<SpriteRenderer>().sprite.name.Contains("right")) Helditem.GetComponent<Transform>().position = new Vector2(transform.position.x+0.3f,transform.position.y);
